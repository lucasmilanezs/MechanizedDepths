...
// MYSTICAL DATA CARD (kubejs:mystical_data)
StartupEvents.registry('item', event => {
  event.create('mystical_data')
    .displayName('Mystical Data')
    .texture('custom:item/mystical_data');
});

// MYSTICAL TECH CARD (kubejs:mystical_tech_card)
StartupEvents.registry('item', event => {
  event.create('mystical_tech_card')
